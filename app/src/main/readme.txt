...
However, you should include a link to this page (http://www.fatcow.com/free-icons)
in your credits (software or website). The icons may not be resold, sub-licensed,
rented, transferred or otherwise made available for use.

Eldorado + Stroke 3132 min from icojam.com
http://www.icojam.com/blog/?p=668
License: These icons are free to use in any kind of commercial or
non-commercial project unlimited times.

Other Tools Used For this Project
===============================================

Android Asset Studio - Wonderful tool to create assets!
http://romannurik.github.io/AndroidAssetStudio/index.html

Coursera MOOC Discussion Forums - Thank you to all who posted!

GENYMOTION
Free VERSION AGREEMENT : Personal and private use only, exclusion of all other uses
(https://shop.genymotion.com/index.php?id_cms=3&controller=cms)
