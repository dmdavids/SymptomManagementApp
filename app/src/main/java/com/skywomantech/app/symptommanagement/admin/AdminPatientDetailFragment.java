 ...
 * in two-pane mode (on tablets) or a {@link com.skywomantech.app.symptommanagement.admin.AdminPatientDetailActivity}
 * on handsets.
 */
public class AdminPatientDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.adminpatient_detail)).setText(mItem.content);
        }
