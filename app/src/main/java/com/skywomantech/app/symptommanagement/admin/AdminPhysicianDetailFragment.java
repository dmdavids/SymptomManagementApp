 ...
 * in two-pane mode (on tablets) or a {@link com.skywomantech.app.symptommanagement.admin.AdminPhysicianDetailActivity}
 * on handsets.
 */
public class AdminPhysicianDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.adminphysician_detail)).setText(mItem.content);
        }
