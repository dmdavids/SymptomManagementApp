 ...
 * lead to a {@link com.skywomantech.app.symptommanagement.admin.AdminPhysicianDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link AdminPhysicianListFragment} and the item details
 * (if present) is a {@link com.skywomantech.app.symptommanagement.admin.AdminPhysicianDetailFragment}.
 * <p>
...
public class AdminPhysicianListActivity extends Activity
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(AdminPhysicianDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(AdminPhysicianDetailFragment.ARG_ITEM_ID, id);
