    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_PATIENT_TABLE =
                "CREATE TABLE " + PatientEntry.TABLE_NAME + " (" +
                        ...
                        PatientEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
        ...
        final String SQL_CREATE_PRESCRIPTION_TABLE =
                "CREATE TABLE " + PrescriptionEntry.TABLE_NAME + " (" +
                        ...
                        PrescriptionEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        PrescriptionEntry.COLUMN_MEDICATION_ID + " REAL UNIQUE NOT NULL, " +
        ...
        final String SQL_CREATE_PHYSICIAN_TABLE =
                "CREATE TABLE " + PhysicianEntry.TABLE_NAME + " (" +
                        ...
                        PhysicianEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        PhysicianEntry.COLUMN_PHYSICIAN_ID + " REAL UNIQUE NOT NULL, " +
        ...
        final String SQL_CREATE_PAIN_LOG_TABLE =
                "CREATE TABLE " + PainLogEntry.TABLE_NAME + " (" +
                        ...
                        PainLogEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        PainLogEntry.COLUMN_PAIN_LOG_ID + " REAL, " +
        ...
        final String SQL_CREATE_MED_LOG_TABLE =
                "CREATE TABLE " + MedLogEntry.TABLE_NAME + " (" +
                        ...
                        MedLogEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        MedLogEntry.COLUMN_MED_LOG_ID + " REAL, " +
        ...
        final String SQL_CREATE_STATUS_LOG_TABLE =
                "CREATE TABLE " + StatusLogEntry.TABLE_NAME + " (" +
                        ...
                        StatusLogEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        StatusLogEntry.COLUMN_STATUS_LOG_ID + " REAL, " +
        ...
        final String SQL_CREATE_REMINDER_TABLE =
                "CREATE TABLE " + ReminderEntry.TABLE_NAME + " (" +
                        ...
                        ReminderEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        ReminderEntry.COLUMN_REMINDER_ID + " REAL, " +
        ...
        final String SQL_CREATE_PREFS_TABLE =
                "CREATE TABLE " + PrefsEntry.TABLE_NAME + " (" +
                        ...
                        PrefsEntry.COLUMN_PATIENT_ID + " REAL UNIQUE NOT NULL, " +
                        PrefsEntry.COLUMN_PREF_ID + " REAL, " +
