...
/**
 * An activity representing a list of AdminPatients. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link com.skywomantech.app.symptommanagement.admin.AdminPatientDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link AdminPatientListFragment} and the item details
 * (if present) is a {@link com.skywomantech.app.symptommanagement.admin.AdminPatientDetailFragment}.
 * <p>
...
public class AdminPatientListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.adminpatient_detail_container) != null) {
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(AdminPatientDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(AdminPatientDetailFragment.ARG_ITEM_ID, id);
